...
function checkWin(myPlayer, otherPlayer) {
	...
	document.getElementById(result[0].bull).innerText= B;
	document.getElementById(result[0].hit).innerText= H;
	document.getElementById(result[0].guess).innerText= guess;
};
